...
{{- if .Values.envFromSecret.secretName }}
{{- .Values.envFromSecret.secretName }}
{{- else }}
{{- printf "%s-secret" (include "microservice.fullname" .) }}
{{- end }}
{{- end }}
...
{{- if .Values.envFromConfigMap.configMapName }}
{{- .Values.envFromConfigMap.configMapName }}
{{- else }}
{{- printf "%s-configmap" (include "microservice.fullname" .) }}
{{- end }}
{{- end }}
